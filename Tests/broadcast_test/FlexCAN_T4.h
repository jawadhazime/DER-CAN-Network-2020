...
typedef struct CANFD_timings_t {
  double baudrate = 500000;
  double baudrateFD = 1000000;
...
class FlexCAN_T4_Base {
  public:
    ...
    virtual void setBaudRate(uint32_t baud = 500000) = 0;
...
FCTPFD_CLASS class FlexCAN_T4FD : public FlexCAN_T4_Base {
  ...
  private:
    ...
    void setBaudRate(uint32_t baud = 500000) { ; } // unused, CAN2.0 only (needed for base class existance)
...
FCTP_CLASS class FlexCAN_T4 : public FlexCAN_T4_Base {
  public:
    ...
    void setTx(FLEXCAN_PINS pin = DEF);
    void setRx(FLEXCAN_PINS pin = DEF);
    void setBaudRate(uint32_t baud = 500000);
    void reset() { softReset(); } /* reset flexcan controller (needs register restore capabilities...) */
...
#include "C:\Repos\UMD\FSAE\FlexCAN_T4-master\examples\beta_sample\FlexCAN_T4.tpp"

#if defined(__IMXRT1062__)
#include "C:\Repos\UMD\FSAE\FlexCAN_T4-master\examples\beta_sample\FlexCAN_T4FD.tpp"
#include "C:\Repos\UMD\FSAE\FlexCAN_T4-master\examples\beta_sample\FlexCAN_T4FDTimings.tpp"
#endif
